...
export function IconSymbol({
  ...
  // prefer mapped Material icon name, otherwise use the provided name as a fallback
  const materialName = MAPPING[name as IconSymbolName] ?? (name as unknown as string);
