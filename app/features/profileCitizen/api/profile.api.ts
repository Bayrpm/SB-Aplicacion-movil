...
/**
 * NOTA: Las funciones de comentarios y reacciones han sido movidas a @/app/features/report/api/report.api.ts
 * para centralizar toda la lógica de denuncias en un solo lugar.
 * 
 * Las funciones que se movieron:
 * - fetchReportStats()
 * - reactToReport()
 * - fetchReportComments()
 * - createReportComment()
 ...
 * - deleteReportComment()
 * 
 * Por favor importar desde @/app/features/report/api/report.api.ts
 */
